...
urlpatterns = [
    ...
    path('invoicess/news', views.invoice_creates, name='invoice_creates'),
    path('invoicess/deletes', views.invoice_deletes, name='invoice_deletes'),
    ...
    path('invoicess', views.invoicess, name='invoicess'),
    path('invoices/<int:invoice_id>', views.invoice_viewers, name='invoice_viewers'),
